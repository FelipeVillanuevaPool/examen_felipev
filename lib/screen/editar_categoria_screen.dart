...
import 'package:FelipeV_Examen/providers/category_form_provider.dart';
        ...
        children: [
          FloatingActionButton(
            ...
            onPressed: () async {
              ...
              await categoryService.deleteCategoria(categoryForm.categoria, context);
            },
            heroTag: null,
          ),
          ...
          FloatingActionButton(
            ...
            onPressed: () async {
              if (!categoryForm.isValidForm()) return;
              await categoryService.editOrCreateCategoria(categoryForm.categoria,context);
            },
            heroTag: null,
          ),
        ],
