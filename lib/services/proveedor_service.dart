...
class ProveedorService extends ChangeNotifier {
  ...
  List<Lst_proveedor> proveedor = [];
  Lst_proveedor? SelectProv;
  bool isLoading = true;
...
Future editOrCreateProv(Lst_proveedor proveedor , BuildContext context) async {
    isEditCreate = true;
    notifyListeners();
  ...
  Future<String> updateProv(Lst_proveedor prov) async {
    final url = Uri.http(
      _baseUrl,
  ...
  Future createProv(Lst_proveedor proveedor) async {
    final url = Uri.http(
      _baseUrl,
  ...
  Future deleteProv(Lst_proveedor proveedor, BuildContext context) async {
    final url = Uri.http(
      _baseUrl,
